...
Python Translator will help you to translate your dBase software.

This README will describe an overview of Translator for Python. If you want to read general documentation, see /README.md.

## What Python Translator get from source code

This script will scan all strings in function-return(allowed void function) statement.

Translator for Python will search this text in each source code line:  

Translator for Python will discard lines that observe above criteria but contains:  
